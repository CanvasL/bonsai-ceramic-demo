...
import {Consumer} from "../contracts/Consumer.sol";
...
contract Deploy is Script, BonsaiCheats, BonsaiDeploy {
    function run() external {
        ...
        bytes32 imageId = queryImageId("CHECK_COMMIT_VALIDITY");
        console2.log("ImageID: ", vm.toString(imageId));
        Consumer app = new Consumer(address(bonsaiRelay), imageId);
        console2.log("Consumer: ", address(app));
